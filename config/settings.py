...
# AUTH_USER_MODEL = 'user.CustomUser' # auth user model
...
# django default sqlite3 database
...
TIME_ZONE = 'Asia/Tashkent' # for Uzbekistan

USE_I18N = True # for language

USE_TZ = True # for time zone
